...
function randomNumber() {
    randomNumber= quick_draw_data_set;
...
function updateCanvas() {
    ...
    quick_draw_data_set=randomNumber;
    console.log(randomNumber);
}

function setup() {
if (mouseup) {
   Classifier.classifyCanvas();
}
}
...
function gotResult(results,error) {
    ...
    if (results) {
        console.log(results);
        results[0];
        document.getElementById(drawing).innerHTML=("Your sketch:"+results[0]);
